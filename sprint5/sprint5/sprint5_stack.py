...
class Sprint5Stack(cdk.Stack):
    ...
    #    vpc = ec2.Vpc(self, "Shanawar_VPC")
        ...
        cluster.add_capacity("ShanawarClustercapacity",instance_type=ec2.InstanceType("t2.micro"))
        
        #3 Create Task Definition and add docker container to it.
        ...
        #4 Instantiate an Amazon ECS Service
